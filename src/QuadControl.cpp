...
V3F QuadControl::BodyRateControl(V3F pqrCmd, V3F pqr)
{
  ...
  /*
  //V3F rate_error = pqr - pqrCmd;
  V3F rate_error = pqrCmd - pqr;
  V3F inertia = V3F(Ixx, Iyy, Izz);
  momentCmd = inertia * (kpPQR * rate_error);
  */
  /////////////////////////////// END STUDENT CODE ////////////////////////////
...
V3F QuadControl::RollPitchControl(V3F accelCmd, Quaternion<float> attitude, float collThrustCmd)
{
  ...
  {
      float target_R13 = accelCmd[0]/c_d; // Restrict to max tilt of maxTiltAngle
      float target_R23 = accelCmd[1]/c_d; // Restrict to max tilt of maxTiltAngle
